 ...
 */
public class SongDeskGrid1Adater extends BAdapter<ListInfo> {
    private static final String TAG = "SongDeskGrid1Adater";

    Context context;

    public SongDeskGrid1Adater(Context context, int layoutId, List<ListInfo> list) {
