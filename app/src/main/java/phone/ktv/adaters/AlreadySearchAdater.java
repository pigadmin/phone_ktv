    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            if (isState) {
                ...
                holder2.text3 = convertView.findViewById(R.id.name_tvw12);
                holder2.text4 = convertView.findViewById(R.id.song_name12_tvw);
        ...
        if (isState) {
            ...
            holder2.text3.setText(playBean.name);
            holder2.text4.setText(playBean.singerTypeName);
        }
        return convertView;
    }
